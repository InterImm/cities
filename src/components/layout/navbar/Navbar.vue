  ...
  <nav class="navbar app-navbar navbar-toggleable-md">
    ...
    <div class="row navbar-container">
      ...
      <div class="col nav-item dropdown navbar-dropdown d-flex align-items-center justify-content-center" v-dropdown>
        <a class="nav-link d-flex align-items-center justify-content" href="https://github.com/InterImm/cities" @click.prevent="closeMenu">
        ...
        <div class="dropdown-menu last">
          <div class="dropdown-menu-content">
            <div class="dropdown-item plain-link-item">
              <a class="plain-link" href="http://interimm.org">星际移民中心</a>
            </div>
            <div class="dropdown-item plain-link-item">
              <a class="plain-link" href="http://interimm.org/mars-map/">火星地图</a>
            </div>
            <div class="dropdown-item plain-link-item">
              <a class="plain-link" href="http://book.interimm.org/history/mars_immigration.html#marscities">火星历史</a>
            </div>
